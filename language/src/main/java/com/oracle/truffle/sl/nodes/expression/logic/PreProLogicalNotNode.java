 ...
 * SOFTWARE.
 */
package com.oracle.truffle.sl.nodes.expression.logic;
...
@NodeChild("valueNode")
@NodeInfo(shortName = "!")
public abstract class PreProLogicalNotNode extends PreProExpressionNode {

    @Specialization
    protected PreProConstant doBoolean(PreProConstant value) {
        return PreProConstant.not(value);
    }

    @Fallback
    protected Object typeError(Object value) {
        throw PreProException.typeError(this, value);
    }
