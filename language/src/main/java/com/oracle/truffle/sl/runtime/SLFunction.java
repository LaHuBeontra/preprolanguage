...
public final class SLFunction implements TruffleObject {
    ...
    private static final TruffleLogger LOG = TruffleLogger.getLogger(PreProLanguage.ID, SLFunction.class);
    ...
    protected SLFunction(PreProLanguage language, String name) {
        this.name = name;
