...
public abstract class SLPrintlnBuiltin extends SLBuiltinNode {
    ...
    @Specialization
    public long println(long value, @CachedContext(PreProLanguage.class) SLContext context) {
    ...
    @Specialization
    public boolean println(boolean value, @CachedContext(PreProLanguage.class) SLContext context) {
        doPrint(context.getOutput(), value);
        return value;
    }
    ...
    @Specialization
    public String println(String value, @CachedContext(PreProLanguage.class) SLContext context) {
        doPrint(context.getOutput(), value);
        return value;
    }
    ...
    @Specialization
    public Object println(Object value, @CachedContext(PreProLanguage.class) SLContext context) {
        doPrint(context.getOutput(), value);
        return value;
    }
