 ...
 * SOFTWARE.
 */
package com.oracle.truffle.sl.nodes.expression.object;
...
import com.oracle.truffle.sl.nodes.util.PreProToMemberNode;
import com.oracle.truffle.sl.runtime.PreProUndefinedNameException;

//TODO: PrePro doesn't have objects yet, so this is not needed. Extension?
...
@NodeChild("nameNode")
@NodeChild("valueNode")
public abstract class PreProWritePropertyNode extends PreProExpressionNode {
    ...
    protected Object write(Object receiver, Object index, Object value,
        ...
        try {
            ...
            throw PreProUndefinedNameException.undefinedProperty(this, index);
        }
        return value;
    }
    ...
    protected Object write(Object receiver, Object name, Object value,
                           ...
                           @Cached PreProToMemberNode asMember) {
        try {
            ...
            throw PreProUndefinedNameException.undefinedProperty(this, name);
        }
        return value;
    }
}
