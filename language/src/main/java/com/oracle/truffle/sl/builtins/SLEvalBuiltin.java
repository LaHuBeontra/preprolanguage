...
public abstract class SLEvalBuiltin extends SLBuiltinNode {
    ...
    public Object evalCached(String id, String code,
                    ...
                    @CachedContext(PreProLanguage.class) SLContext context,
    ...
    public Object evalUncached(String id, String code, @CachedContext(PreProLanguage.class) SLContext context) {
